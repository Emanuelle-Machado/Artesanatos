        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.vendas.index')" :active="request()->routeIs('admin.vendas.index')">
                        {{ __('Vendas') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('admin.relatorios.index')" :active="request()->routeIs('admin.relatorios.index')">
                        {{ __('Relatórios') }}
                    </x-nav-link>
